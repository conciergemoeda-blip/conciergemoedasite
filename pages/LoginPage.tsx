            ...
            <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-8 animate-fade-in-up">
                ...
                <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-white px-4 text-gray-500 font-bold">ou</span>
                    </div>
                </div>
                ...
                <button
                    ...
                    className="w-full bg-white hover:bg-gray-50 text-gray-700 font-bold py-4 rounded-xl border border-gray-200 shadow-sm transition-all active:scale-95 flex items-center justify-center gap-3"
                >
